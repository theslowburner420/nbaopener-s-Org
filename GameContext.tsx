...
export const GameProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const contextValue = useMemo(() => ({
    ...
    startFranchise,
    updateFranchise
  }), [state, isAuthLoading, isInitialSyncDone, isOffline, syncError, showWelcomeGift, setCoins, addCoins, spendCoins, addToCollection, addCustomCard, setCurrentView, unlockAchievement, claimAchievementReward, claimReward, addPackToInventory, removePackFromInventory, setPremium, resetGame, updateGameState, forceSync, refreshFromCloud, showRewardedAd, isSaving, isBackgroundSaving, login, logout, claimLoginReward, startFranchise, updateFranchise]);
