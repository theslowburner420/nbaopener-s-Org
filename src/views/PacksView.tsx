  ...
  return (
    <div className="min-h-full w-full flex flex-col bg-black text-white relative">
      ...
      <header className="sticky top-0 z-30 backdrop-blur-md bg-black/90 px-3 border-b border-white/5 flex items-center justify-between gap-2 h-11 shrink-0 w-full">
        ...
        {/* Clean Coin Balance (No +COINS button) */}
            ...
            >
              {PACKS.map((pack) => {
                ...
                return (
                  <div
                    key={pack.id}
                    className="group bg-zinc-950/70 rounded-xl border border-white/5 p-2.5 flex flex-col justify-between transition-all duration-300 hover:border-amber-400/30"
                  >
                    {/* Pack Art Image */}
