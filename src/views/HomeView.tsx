...
const HomeView: React.FC = () => {
  ...
  return (
    <div className="min-h-full w-full flex flex-col bg-black relative">
      <div className="flex-1 overflow-y-auto flex flex-col gap-1.5 md:gap-4 p-1.5 md:p-6 pb-24 md:pb-10 max-w-7xl mx-auto w-full">
        <div className="grid grid-cols-2 gap-1.5 md:gap-4">
          {/* Bloque A: Pack Opener */}
          <motion.div 
            initial={{ opacity: 0, scale: 0.95 }}
            animate={{ opacity: 1, scale: 1 }}
            className="relative group cursor-pointer overflow-hidden rounded-2xl md:rounded-[2.5rem] border border-white/5 bg-zinc-900 aspect-square md:aspect-video flex flex-col items-center justify-center p-4"
          ...
          >
            ...
            <div className="absolute top-2 right-2 md:top-4 md:right-4 z-20">
               <motion.div 
                 ...
                 className="px-2 py-0.5 md:px-4 md:py-1 bg-black border border-amber-500/50 rounded-full shadow-[0_0_10px_#f59e0b]"
               >
        ...
        {/* Bottom Section - more squashed for mobile */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-1.5 md:gap-4 flex-1">
          {/* Bloque C: Online Trading */}
          <motion.div 
            initial={{ opacity: 0, y: 15 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.1 }}
            className="relative group cursor-pointer overflow-hidden rounded-2xl md:rounded-[2.5rem] border border-white/5 bg-zinc-950 aspect-[3/1] md:aspect-auto"
