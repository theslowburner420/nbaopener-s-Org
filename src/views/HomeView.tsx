    ...
    <div className="w-full flex flex-col bg-black">
      ...
      <div className="flex-1 flex flex-col gap-1.5 md:gap-4 p-1.5 md:p-6 pb-6 md:pb-6 max-w-7xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-1.5 md:gap-4">
          {/* Bloque C: Market (Trading Hub & Casino Minigames) */}
          <motion.div 
          ...
          >
            <div className="absolute inset-0 z-0">
              <img 
                src="https://i.ibb.co/PsVSbfnv/file-00000000795881f48e836b5fa0842657.png" 
                alt="Market" 
                className="w-full h-full object-cover opacity-90 transition-transform duration-700 group-hover:scale-110"
                referrerPolicy="no-referrer"
                onError={(e) => {
                  const target = e.currentTarget;
                  if (!target.src.includes('rKXWL1SR')) {
                    target.src = "https://i.ibb.co/rKXWL1SR/file-00000000795881f48e836b5fa0842657.png";
                  } else {
                    target.src = "https://i.postimg.cc/PJ7m51xb/generated-image-(2).png";
                  }
                }}
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent" />
