...
import AdBannerRoot from './components/AdBannerRoot';
...
function AppContent() {
  ...
  return (
    <div className={`h-[100dvh] w-full bg-black text-white flex flex-col font-sans selection:bg-amber-500 selection:text-black relative overflow-hidden ${
      ...
      {/* Header & Fixed Top Ad Area */}
      <div className="relative z-[9000] flex flex-col bg-black shrink-0">
        {/* Adsterra Root Banner - Fix damunt del header, muntat una sola vegada a l'arrel */}
        <AdBannerRoot isPremium={isPremium} />
