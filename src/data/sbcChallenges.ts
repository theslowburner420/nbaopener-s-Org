    ...
    segments: [
{
  ...
  {
    id: 'sbc-group-dynasty-lakers-showtime-80s',
    name: 'Showtime Lakers Dynasty',
    description: 'Complete all 3 squad challenges to unlock the 98 OVR Showtime Lakers Dynasty card.',
    category: 'dynasty',
    difficulty: 'legendary',
    type: 'permanent',
    expiresAt: null,
    isActive: true,
    reward: {
      playerName: 'Showtime Lakers Dynasty',
      playerId: 'dynasty-lakers-showtime-80s',
      rarity: 'legend',
      ovr: 98,
    ...
    segments: [
{
            id: 'dynasty-showtime-seg-1',
            name: 'Showtime Foundation',
            description: 'Submit 5 cards: Team OVR >= 84, min 3 Los Angeles Lakers 80s era cards.',
            cardsRequired: 5,
            slotPositions: [
                  'PG',
                  'SG',
            ...
            segmentReward: {
                  ...
                  packType: 'duo_xfactor',
                  packName: 'Dynamic Duo & X-Factor',
                  description: '3,000 Coins + 1x Duo Pack'
            }
      },
      {
            id: 'dynasty-showtime-seg-2',
            name: 'Junior Skyhook 1987 Moment',
            description: 'Submit 1 card: Magic Johnson — Moment \'Junior Skyhook\' (1987).',
            cardsRequired: 1,
            slotPositions: [
                  'PG'
            ],
            requirements: [
                  ...
                  },
                  {
                        type: 'SPECIFIC_PLAYER_NAME',
                        value: 'Magic Johnson',
                        edition: 'Moment \'Junior Skyhook\' (1987)',
                        count: 1
                  }
            ],
            segmentReward: {
      ...
      {
            id: 'dynasty-showtime-seg-3',
            name: 'Magic & Kareem Showtime Duo',
            description: 'Submit 2 cards: Magic Johnson + Kareem Abdul-Jabbar (both LAL), Team OVR >= 89.',
            cardsRequired: 2,
            slotPositions: [
                  'PG',
                  'C'
  ...
  {
    id: 'sbc-group-dynasty-lakers-three-peat',
    name: 'Lakers Three-Peat Dynasty',
    description: 'Complete all 3 squad challenges to unlock the 98 OVR Shaq & Kobe Three-Peat Dynasty card.',
    category: 'dynasty',
    difficulty: 'legendary',
    type: 'permanent',
    expiresAt: null,
    isActive: true,
    reward: {
      playerName: 'Lakers Three-Peat Dynasty',
      playerId: 'dynasty-lakers-three-peat-2000-2002',
      rarity: 'legend',
      ovr: 98,
    ...
    segments: [
{
            id: 'dynasty-threepeat-seg-1',
            name: 'Three-Peat Era Foundation',
            description: 'Submit 5 cards: Team OVR >= 85, min 3 Los Angeles Lakers 2000-2002 era cards.',
            cardsRequired: 5,
            slotPositions: [
                  'PG',
                  'SG',
            ...
            segmentReward: {
                  ...
                  packType: 'duo_xfactor',
                  packName: 'Dynamic Duo & X-Factor',
                  description: '3,500 Coins + 1x Duo Pack'
            }
      },
      {
            id: 'dynasty-threepeat-seg-2',
            name: 'Kobe & Shaq Dominant Duo',
            description: 'Submit 2 cards: Kobe Bryant + Shaquille O\'Neal (both LAL), Team OVR >= 90.',
            cardsRequired: 2,
            slotPositions: [
                  'SG',
                  'C'
      ...
      {
            id: 'dynasty-threepeat-seg-3',
            name: 'Mamba Iconic Moment',
            description: 'Submit 1 card: Kobe Bryant — Moment \'Game 4 Buzzer Beater vs Suns\' (2006) or \'81-Point Master\'.',
            cardsRequired: 1,
            slotPositions: [
                  'SG'
            ],
            requirements: [
                  ...
                  },
                  {
                        type: 'SPECIFIC_PLAYER_NAME',
                        value: 'Kobe Bryant',
                        edition: 'Moment \'Game 4 Buzzer Beater vs Suns\' (2006) or \'81-Point Master\'',
                        count: 1
                  }
            ],
            segmentReward: {
  ...
  {
    id: 'sbc-group-dynasty-spurs-1999-2014',
    name: 'San Antonio Spurs Dynasty',
    description: 'Complete all 3 squad challenges to unlock the 97 OVR San Antonio Spurs Dynasty card.',
    category: 'dynasty',
    difficulty: 'legendary',
    type: 'permanent',
    expiresAt: null,
    isActive: true,
    reward: {
      playerName: 'San Antonio Spurs Dynasty',
      playerId: 'dynasty-spurs-1999-2014',
      rarity: 'legend',
      ovr: 97,
    ...
    segments: [
{
            id: 'dynasty-spurs-seg-1',
            name: 'Silver & Black Foundation',
            description: 'Submit 5 cards: Team OVR >= 83, min 3 San Antonio Spurs cards.',
            cardsRequired: 5,
            slotPositions: [
                  'PG',
                  'SG',
      ...
      {
            id: 'dynasty-spurs-seg-2',
            name: 'Tim Duncan Finals MVP',
            description: 'Submit 1 card: Tim Duncan — Finals MVP (1999, 2003, or 2005).',
            cardsRequired: 1,
            slotPositions: [
                  'PF'
            ],
            requirements: [
                  ...
                  },
                  {
                        type: 'SPECIFIC_PLAYER_NAME',
                        value: 'Tim Duncan',
                        edition: 'Finals MVP (1999, 2003, 2005)',
                        count: 1
                  }
            ],
            segmentReward: {
      ...
      {
            id: 'dynasty-spurs-seg-3',
            name: 'Ginobili or Parker Championship Guard',
            description: 'Submit 3 cards: Min 1 of Manu Ginobili or Tony Parker (SAS), Team OVR >= 87.',
            cardsRequired: 3,
            slotPositions: [
                  'SG',
                  'PG',
            ...
            requirements: [
                  ...
                  {
                        type: 'SPECIFIC_PLAYER_NAME',
                        value: 'Manu Ginobili or Tony Parker',
                        count: 1,
                        playersList: [
                              'Manu Ginobili',
                              'Tony Parker'
  ...
  {
    id: 'sbc-group-dynasty-miami-heat-big-three',
    name: 'Miami Heat Big Three Dynasty',
    description: 'Complete all 3 squad challenges to unlock the 97 OVR Miami Heat Big Three Dynasty card.',
    category: 'dynasty',
    difficulty: 'legendary',
    type: 'permanent',
    expiresAt: null,
    isActive: true,
    reward: {
      playerName: 'Miami Heat Big Three Dynasty',
      playerId: 'dynasty-miami-heat-big-three',
      rarity: 'legend',
      ovr: 97,
    ...
    segments: [
{
            id: 'dynasty-heat-seg-1',
            name: 'South Beach Big Three Era',
            description: 'Submit 5 cards: Team OVR >= 83, min 3 Miami Heat 2010-2014 era cards.',
            cardsRequired: 5,
            slotPositions: [
                  'PG',
                  'SG',
      ...
      {
            id: 'dynasty-heat-seg-2',
            name: 'The Big Three Trio',
            description: 'Submit 3 cards: LeBron James + Dwyane Wade + Chris Bosh (all MIA), Team OVR >= 88.',
            cardsRequired: 3,
            slotPositions: [
                  'SF',
                  'SG',
      ...
      {
            id: 'dynasty-heat-seg-3',
            name: 'LeBron James Finals MVP',
            description: 'Submit 1 card: LeBron James — Finals MVP 2012 or 2013 (Miami Heat).',
            cardsRequired: 1,
            slotPositions: [
                  'SF'
            ],
            requirements: [
                  ...
                  },
                  {
                        type: 'SPECIFIC_PLAYER_NAME',
                        value: 'LeBron James',
                        edition: 'Finals MVP 2012 or 2013 (MIA)',
                        count: 1
                  }
            ],
            segmentReward: {
  ...
  {
    id: 'sbc-group-dynasty-detroit-bad-boys',
    name: 'Bad Boys Pistons Dynasty',
    description: 'Complete both squad challenges to unlock the 96 OVR Bad Boys Pistons Dynasty card.',
    category: 'dynasty',
    difficulty: 'legendary',
    type: 'permanent',
    expiresAt: null,
    isActive: true,
    reward: {
      playerName: 'Bad Boys Pistons Dynasty',
      playerId: 'dynasty-detroit-pistons-bad-boys',
      rarity: 'legend',
      ovr: 96,
    ...
    segments: [
{
            id: 'dynasty-pistons-seg-1',
            name: 'Motor City Defense',
            description: 'Submit 5 cards: Team OVR >= 82, min 3 Detroit Pistons 80s era cards.',
            cardsRequired: 5,
            slotPositions: [
                  'PG',
                  'SG',
      ...
      {
            id: 'dynasty-pistons-seg-2',
            name: 'Isiah Thomas 1990 Finals MVP',
            description: 'Submit 1 card: Isiah Thomas — Finals MVP 1990.',
            cardsRequired: 1,
            slotPositions: [
                  'PG'
            ],
